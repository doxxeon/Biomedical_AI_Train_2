...
with open("/Users/kimdohyeon/건양대학교병원_바이오헬스/Biomedical_AI_Train/MLP/MLP_Practice/MLP_Practice_05/train.csv") as csv_f:
...
def train(train_dataset, valid_dataset, epochs=5):
    ...
    encoder = tf.keras.layers.TextVectorization(output_sequence_length=200,
        vocabulary="/Users/kimdohyeon/건양대학교병원_바이오헬스/Biomedical_AI_Train/MLP/MLP_Practice/MLP_Practice_05/vocab.csv")
    ...
    model = tf.keras.Sequential([
        ...
        tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(300)), # bidirectional: True로 설정하여 양방향 LSTM을 사용합니다.
...
root_path = "/Users/kimdohyeon/건양대학교병원_바이오헬스/Biomedical_AI_Train/MLP/MLP_Practice/MLP_Practice_05/"
