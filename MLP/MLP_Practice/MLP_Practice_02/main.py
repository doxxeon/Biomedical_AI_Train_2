...
def count_words(input_text):
    ...
    output_dict = {}
    word_tokenized_text = word_tokenize(input_text)
...
def remove_stopwords(input_dict):
    ...
    output_dict = {}
    word_tokenized_text = word_tokenize(input_dict.keys())
...
def remove_less_freq(input_dict, lower_bound=10):
    ...
    output_dict = {word. lower(): count for word, count in input_dict.items() if count > lower_bound}
    return output_dict
