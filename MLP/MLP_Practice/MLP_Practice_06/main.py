...
with open("/Users/kimdohyeon/건양대학교병원_바이오헬스/Biomedical_AI_Train/MLP/MLP_Practice/MLP_Practice_06/test.csv") as csv_f:
...
root_path = "/Users/kimdohyeon/건양대학교병원_바이오헬스/Biomedical_AI_Train/MLP/MLP_Practice/MLP_Practice_06/"
test_file_path = root_path + "test.csv"

# 데이터 불러오기
# <ToDo>: test_dataset을 불러오세요.
test_dataset = tf.data.experimental.make_csv_dataset(test_file_path, column_names=column_names, batch_size=320,
                                                     label_name="label", column_defaults=column_defaults,
                                                     header=False, num_epochs=1) # Problem 1
