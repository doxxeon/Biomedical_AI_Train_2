...
raw_text = pd.read_csv("/Users/kimdohyeon/건양대학교병원_바이오헬스/Biomedical_AI_Train/MLP/250529/q4/emotions_train.txt", delimiter=';', header=None, names=['sentence','emotion'])
...
test_result = clf.predict(cv.transform(test_data))
print(test_result)