...
with open('/Users/kimdohyeon/건양대학교병원_바이오헬스/Biomedical_AI_Train_2/MLP/MLP5/q3/bow_models.pkl', 'rb') as f:
...
vec1 = vectorizer.transform(sent1).toarray()[0]
vec2 = vectorizer.transform(sent2).toarray()[0]
...
sim2 = cosine_similarity([vec1], X[0].toarray())[0][0]
