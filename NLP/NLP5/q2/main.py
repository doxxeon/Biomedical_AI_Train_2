...
with open("/Users/kimdohyeon/건양대학교병원_바이오헬스/Biomedical_AI_Train_2/MLP/MLP5/q2/text.txt", 'r') as f:
    documents = []
    for line in f:
...
unibigram_X = TfidfVectorizer(
    ngram_range=(1, 2),  # unigram과 bigram을 포함
    tokenizer=lambda x: x.split(),
    lowercase=False
